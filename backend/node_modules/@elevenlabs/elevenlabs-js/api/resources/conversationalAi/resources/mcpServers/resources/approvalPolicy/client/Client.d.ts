...
export declare class ApprovalPolicy {
     ...
     *     })
     */
    update(mcpServerId: string, request: ElevenLabs.conversationalAi.mcpServers.McpApprovalPolicyUpdateRequestModel, requestOptions?: ApprovalPolicy.RequestOptions): core.HttpResponsePromise<ElevenLabs.McpServerResponseModel>;
    private __update;
}
