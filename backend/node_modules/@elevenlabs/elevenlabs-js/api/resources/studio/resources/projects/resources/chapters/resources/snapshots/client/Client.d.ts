...
export declare class Snapshots {
     ...
     * @throws {@link ElevenLabs.UnprocessableEntityError}
     */
    stream(projectId: string, chapterId: string, chapterSnapshotId: string, request?: ElevenLabs.studio.projects.chapters.BodyStreamChapterAudioV1StudioProjectsProjectIdChaptersChapterIdSnapshotsChapterSnapshotIdStreamPost, requestOptions?: Snapshots.RequestOptions): core.HttpResponsePromise<ReadableStream<Uint8Array>>;
    private __stream;
}
